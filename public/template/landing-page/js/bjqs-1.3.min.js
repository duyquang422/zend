        ...
        var n = {
            ...
            if (r.animtype === "slide") {
                ...
                e(window).resize(function () {
                    ...
                    i.css({height: m.height});
                    h.css({height: '550px', width: m.width});
                    w(function () {
                        O(!1, v.currentslide)
            ...
            if (r.responsive && m.width < r.width) {
                h.css({width: m.width, height: '550px', overflow: "hidden", position: "relative"});
                s.css({width: m.width * (v.slidecount + 2), left: -m.width * v.currentslide})
            } else {
                h.css({width: r.width, height: '550px', overflow: "hidden", position: "relative"});
            ...
            e.each(o, function (t, n) {
                ...
                if (r) {
                    r = e('<div class="bjqs-caption"><span>' + r + "</span><hr></div>");
                    r.appendTo(e(n))
                }
            })
        }, L = function () {
