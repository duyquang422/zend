...
--
-- Host: 127.0.0.1
-- Generation Time: May 17, 2016 at 12:38 PM
...
(1, 'Hiệu suất thiết bị Android thua xa Apple', 'hieu-suat-thiet-bi-android-thua-xa-apple', '<p>Ph&acirc;n t&iacute;ch của c&ocirc;ng ty di động Blancco Technology Group đ&atilde; đưa ra c&aacute;c kết quả nghi&ecirc;n cứu x&aacute;c định điện thoại n&agrave;o sẽ đứng vững theo th&aacute;ch thức thời gian v&agrave; tiếp tục ph&aacute;t triển m&agrave; kh&ocirc;ng bị thất bại.</p>\n\n<p>Theo nghi&ecirc;n cứu mới nhất của c&ocirc;ng ty, Blancco ph&aacute;t hiện sự ch&ecirc;nh lệch lớn về độ tin cậy khi so s&aacute;nh giữa hai nền tảng n&agrave;y.</p>\n\n<table align="center" style="width:500px">\n	<tbody>\n		<tr>\n			<td><img alt="" src="http://xahoithongtin.com.vn/dataimages/201605/original/images1719368_2.png" /></td>\n		</tr>\n		<tr>\n		</tr>\n	</tbody>\n</table>\n\n<p>Trong b&aacute;o c&aacute;o qu&yacute; 4 của c&ocirc;ng ty, nghi&ecirc;n cứu ph&acirc;n t&iacute;ch về sự thất bại của smartphone&nbsp; trong qu&yacute; đầu&nbsp; ti&ecirc;n của năm 2016 x&aacute;c định rằng, c&aacute;c thiết bị Android g&acirc;y ra nhiều vấn đề cho chủ nh&acirc;n của ch&uacute;ng hơn l&agrave; iPhone. Theo dữ liệu mới của Blancco Technology Group, 44% điện thoại Android gặp lỗi hỏng trong khoảng thời gian từ th&aacute;ng Gi&ecirc;ng v&agrave; th&aacute;ng Ba năm nay, so với 25% iPhone.</p>\n\n<table align="center" style="width:500px">\n	<tbody>\n		<tr>\n			<td><img alt="" src="http://xahoithongtin.com.vn/dataimages/201605/original/images1719372_2.png" /></td>\n		</tr>\n		<tr>\n		</tr>\n	</tbody>\n</table>\n\n<p>Trong số c&aacute;c nh&agrave; cung cấp điện thoại Android, c&aacute;c điện thoại Android c&oacute; tỷ lệ lỗi trải nghiệm cao nhất - 43% to&agrave;n cầu. Galaxy S6 l&agrave; điện thoại gặp c&aacute;c lỗi phổ biến nhất về b&uacute;t từ của Samsung, trong khi iPhone 6 l&agrave; smartphone gặp trục trặc nhiều nhất trong số tất cả c&aacute;c phi&ecirc;n bản iPhone của Apple.</p>\n', 1, 'posts_SoTkr7D1.jpg', 9, '2016-04-07', '', '2016-05-17', '', 0, '', ''),
(2, 'Vietnam Airlines ra mắt website mới với giao diện thân thiện hơn', 'vietnam-airlines-ra-mat-website-moi-voi-giao-dien-than-thien-hon', '<p>Thiết kế giao di&ecirc;̣n trang web mới của Vietnam Airlines được ứng dụng đồng bộ tr&ecirc;n định dạng website v&agrave; mobile tạo sự thuận tiện nhất cho kh&aacute;ch h&agrave;ng.</p>\n\n<p><img alt="" src="http://image.bnews.vn/MediaUpload/Content/2016/05/17/113548_vna-lauchingweb-1205-2-b.png" /></p>\n\n<h2><em>Vietnam Airlines ra mắt giao di&ecirc;̣n website mới. Ảnh: Vietnam Airlines</em></h2>\n\n<p>Ng&agrave;y 16/5/2016, trang web (website) ch&iacute;nh thức của&nbsp;H&atilde;ng h&agrave;ng kh&ocirc;ng quốc gia Việt Nam&nbsp;đ&atilde; ch&iacute;nh thức đưa v&agrave;o sử dụng giao diện mới theo hướng hiện đại, sinh động, tương t&aacute;c th&acirc;n thiện, thuận tiện cho người sử dụng v&agrave; mang m&agrave;u sắc đặc trưng của thương hiệu Vietnam Airlines. &nbsp;</p>\n\n<p>Theo đ&oacute;, cấu tr&uacute;c website được chia th&agrave;nh 3 phần ch&iacute;nh theo đ&uacute;ng chu tr&igrave;nh hoạt động đặt v&eacute; m&aacute;y bay của một h&agrave;nh kh&aacute;ch, bao gồm: &ldquo;L&ecirc;n kế hoạch&rdquo; &ndash; th&ocirc;ng tin v&agrave; chương tr&igrave;nh mua v&eacute; trực tuyến, &ldquo;Th&ocirc;ng tin h&agrave;nh tr&igrave;nh&rdquo; &ndash; th&ocirc;ng tin tra cứu về chuyến bay v&agrave; c&aacute;c dịch vụ đi k&egrave;m, &ldquo;Chương tr&igrave;nh B&ocirc;ng Sen V&agrave;ng&rdquo; &ndash; th&ocirc;ng tin cho kh&aacute;ch h&agrave;ng thường xuy&ecirc;n.</p>\n\n<p>Website mới của H&atilde;ng được thiết kế &aacute;p dụng c&aacute;c xu hướng c&ocirc;ng nghệ mới của thế giới như: ảnh nền phủ rộng hết m&agrave;n h&igrave;nh (hero banner); nhiều h&igrave;nh ảnh v&agrave; hiệu ứng sinh động, bắt mắt; c&aacute;c thiết kế ph&iacute;m tối giản v&agrave; tinh tế. C&aacute;c th&ocirc;ng tin được sắp xếp c&oacute; hệ thống, sử dụng nhiều dạng thức ảnh (infographic), biểu tượng (icon), bảng biểu (table) để kh&aacute;ch h&agrave;ng dễ d&agrave;ng t&igrave;m kiếm th&ocirc;ng tin xuy&ecirc;n suốt&hellip;</p>\n', 1, 'posts_cEKiq9kJ.jpg', 9, '2016-05-17', 'Administrator', '2016-05-17', '', 0, '', ''),
(3, 'Soi chiếc điện thoại ‘bất khả xâm phạm’ của ông Obama', 'soi-chiec-dien-thoai-bat-kha-xam-pham-cua-ong-obama', '<p>Cơ quan An ninh Quốc gia (NSA) chịu tr&aacute;ch nhiệm ch&iacute;nh trong việc thiết kế c&aacute;c t&iacute;nh năng bảo mật cho chiếc BlackBerry của &ocirc;ng Obama khi &ocirc;ng nhậm chức v&agrave;o năm 2008. Chiếc điện thoại của &ocirc;ng được loại bỏ phần lớn c&aacute;c t&iacute;nh năng v&agrave; tiện &iacute;ch để nhường chỗ cho v&ocirc; số c&aacute;c lớp m&atilde; h&oacute;a bảo mật. NSA kh&ocirc;ng chịu tiết lộ liệu tổng thống c&oacute; thể gửi email hay thậm ch&iacute; nhắn tin bằng chiếc điện thoại đặc chế của m&igrave;nh hay kh&ocirc;ng.</p>\n\n<p>Theo tờ<em>&nbsp;India Times</em>, chiếc điện thoại n&agrave;y sau đ&oacute; được thay thế bởi một mẫu n&acirc;ng cấp của BlackBerry, được NSA phối hợp ph&aacute;t triển d&agrave;nh cho ri&ecirc;ng tổng thống Mỹ. Chiếc điện thoại n&agrave;y được t&iacute;ch hợp phần mềm đặc biệt SecurVoice, ph&aacute;t triển bởi h&atilde;ng c&ocirc;ng nghệ bảo mật The Genesis Key v&agrave; c&aacute;c kỹ sư của BlackBerry. Phần mềm n&agrave;y c&oacute; hai cấp độ an ninh, giữa điện thoại với điện thoại v&agrave; giữa điện thoại với nh&agrave; mạng. Điện thoại của &ocirc;ng Obama sử dụng cấp độ an ninh thứ hai. C&aacute;c cuộc gọi được chuyển đến m&aacute;y chủ bảo mật v&agrave; sau đ&oacute; mới kết nối đến điện thoại.</p>\n\n<p><a href="http://static.phapluattp.vn/w800/uploaded/thanhdanh/2016_05_17/dien_thoai_tong_thong_-_reuters_csod.jpg"><img alt="" src="http://static.phapluattp.vn/w470/uploaded/thanhdanh/2016_05_17/dien_thoai_tong_thong_-_reuters_csod.jpg" /></a><br />\n<em>Chiếc điện thoại BlackBerry của &ocirc;ng Obama được thiết kế đặc biệt để loại bỏ mọi rủi ro an ninh. (Ảnh: Reuters)</em></p>\n\n<p>Chiếc điện thoại của &ocirc;ng Obama bị loại bỏ gần như mọi t&iacute;nh năng m&agrave; một tin tặc c&oacute; thể lợi dụng khai th&aacute;c được. N&oacute; kh&ocirc;ng c&oacute; phần mềm chạy tr&ograve; chơi v&agrave; dường như cũng kh&ocirc;ng c&oacute; camera &ldquo;tự sướng&rdquo;. Nhiều khả năng điện thoại kh&ocirc;ng c&ograve;n chức năng nhắn tin th&ocirc;ng thường m&agrave; được bổ sung c&aacute;c ứng dụng nhắn tin &ldquo;si&ecirc;u m&atilde; h&oacute;a&rdquo;.</p>\n\n<p>Theo&nbsp;<em>India Times</em>, chiếc BlackBerry của &ocirc;ng Obama chỉ được giới hạn gọi v&agrave; nhận cuộc gọi từ khoảng 10 số điện thoại c&ugrave;ng sử dụng dạng thức m&atilde; h&oacute;a tương tự. Trong danh bạ &ldquo;ngh&egrave;o n&agrave;n&rdquo; n&agrave;y c&oacute; Ph&oacute; tổng thống Mỹ Joe Biden, ch&aacute;nh văn ph&ograve;ng tổng thống, một v&agrave;i cố vấn cấp cao th&acirc;n t&iacute;n, thư k&yacute; b&aacute;o ch&iacute;, đệ nhất Phu nh&acirc;n Michelle Obama v&agrave; một v&agrave;i th&agrave;nh vi&ecirc;n gia đ&igrave;nh.</p>\n', 1, 'posts_cMCtnYdi.jpg', 9, '2016-05-17', 'Administrator', '2016-05-17', '', 0, '', ''),
(4, 'Tại sao máy tính chỉ có ổ C, D, E... mà không có ổ A, B?', 'tai-sao-may-tinh-chi-co-o-c-d-e-ma-khong-co-o-a-b', '<p>Ng&agrave;y nay, m&aacute;y vi t&iacute;nh đ&atilde; trở th&agrave;nh thiết bị điện tử phổ biến bậc nhất tr&ecirc;n thế giới. Từ c&aacute;c cơ quan, văn ph&ograve;ng đến trường học v&agrave; c&aacute;c hộ gia đ&igrave;nh, gần như ở đ&acirc;u cũng c&oacute; sự hiện diện của chiếc&nbsp;m&aacute;y t&iacute;nh.</p>\n\n<p>Kh&ocirc;ng ai c&oacute; thể phủ nhận sự tiện lợi v&agrave; lợi &iacute;ch của ch&uacute;ng. Tuy nhi&ecirc;n, c&oacute; những thắc mắc xoay quanh chiếc m&aacute;y t&iacute;nh c&oacute; thể nhiều người đ&atilde; đi t&igrave;m nhưng chưa thấy lời c&acirc;u trả lời.</p>\n\n<p>B&agrave;i viết n&agrave;y sẽ giải đ&aacute;p &quot;tuốt tuồn tuột&quot; những thắc mắc vốn sẵn c&oacute; nhưng chưa được giải đ&aacute;p của bạn!</p>\n\n<p><strong>1. Tại sao m&aacute;y t&iacute;nh chỉ c&oacute; ổ C, D, E... m&agrave; kh&ocirc;ng c&oacute; ổ A, B?</strong></p>\n\n<p><img alt="Tại sao máy tính chỉ có ổ C, D, E... mà không có ổ A, B? - Ảnh 1." id="img_583afb60-1be5-11e6-b3d1-11e3aadf807b" src="https://sohanews2.vcmedia.vn/thumb_w/660/2016/1-1463458148373.PNG" title="Tại sao máy tính chỉ có ổ C, D, E... mà không có ổ A, B? - Ảnh 1." /></p>\n\n<p>Tại sao k&yacute; tự A, B lại kh&ocirc;ng xuất hiện trong m&aacute;y t&iacute;nh, m&agrave; chỉ c&oacute; ổ C, D, E...?</p>\n\n<p>C&acirc;u trả lời l&agrave;&nbsp;<em><strong>m&aacute;y t&iacute;nh đ&atilde; từng c&oacute; ổ A v&agrave; ổ B.</strong></em></p>\n\n<p>Vậy tại sao ng&agrave;y nay m&aacute;y t&iacute;nh kh&ocirc;ng xuất hiện 2 ổ n&agrave;y nữa?</p>\n\n<p>Th&ocirc;ng thường, m&aacute;y vi t&iacute;nh cần phải c&oacute; ổ đĩa để lưu trữ chương tr&igrave;nh v&agrave; dữ liệu. Trong đ&oacute;,&nbsp;ổ đĩa cứng l&agrave; một thiết bị kh&ocirc;ng thể thiếu v&agrave; được lắp sẵn b&ecirc;n trong m&aacute;y.</p>\n\n<p>Ngo&agrave;i ra, m&aacute;y t&iacute;nh c&ograve;n cần đến việc truy xuất đến c&aacute;c dữ liệu b&ecirc;n ngo&agrave;i, do đ&oacute; việc trang bị th&ecirc;m c&aacute;c ổ đĩa mềm l&agrave; điều cần thiết.</p>\n\n<p>Từ những năm mới ra đời, ổ mềm trong m&aacute;y t&iacute;nh được chọn l&agrave; ổ đĩa ch&iacute;nh. Ch&uacute;ng được đặt với c&aacute;c t&ecirc;n l&agrave; ổ A v&agrave; ổ B.</p>\n\n<p>Về sau, việc bổ sung c&aacute;c t&iacute;nh năng mới tr&ecirc;n m&aacute;y t&iacute;nh cộng với việc c&oacute; th&ecirc;m thiết bị lưu trữ USB c&oacute; dung lượng lưu trữ lớn v&agrave; nhiều tiện &iacute;ch hơn n&ecirc;n&nbsp;<strong><em>người ta đ&atilde; bỏ 2 ổ đĩa n&agrave;y đi</em></strong>.</p>\n\n<p><strong>2. Si&ecirc;u m&aacute;y t&iacute;nh v&agrave; m&aacute;y t&iacute;nh kh&aacute;c nhau như thế n&agrave;o?</strong></p>\n\n<p>Nhiều người đ&atilde; v&iacute;, việc so s&aacute;nh&nbsp;<em><u>si&ecirc;u m&aacute;y t&iacute;nh</u></em>&nbsp;với&nbsp;<em><u>m&aacute;y t&iacute;nh</u></em>&nbsp;giống như việc so s&aacute;nh giữa&nbsp;<em><u>cỗ xe tăng</u>&nbsp;</em>với&nbsp;<em><u>xe đồ chơi điều khiển</u></em>&nbsp;từ xa!</p>\n\n<p>Trước khi đi t&igrave;m sự kh&aacute;c biệt giữa si&ecirc;u m&aacute;y t&iacute;nh v&agrave; m&aacute;y t&iacute;nh, mời độc giả điểm qua một ch&uacute;t th&ocirc;ng tin về si&ecirc;u m&aacute;y t&iacute;nh &quot;khủng&quot; nhất thế giới t&iacute;nh cho đến năm 2015.</p>\n\n<p><strong>Fujitsu K</strong>&nbsp;(c&ograve;n gọi l&agrave; K computer)l&agrave; chiếc si&ecirc;u m&aacute;y t&iacute;nh (Supercomputer) đắt nhất v&agrave; chạy nhanh nhất tr&ecirc;n h&agrave;nh tinh.&nbsp;</p>\n\n<p><img alt="Tại sao máy tính chỉ có ổ C, D, E... mà không có ổ A, B? - Ảnh 2." id="img_74f026b0-1bf2-11e6-b3d1-11e3aadf807b" src="https://sohanews2.vcmedia.vn/thumb_w/660/2016/k-supercomputer-1463463789948.jpg" title="Tại sao máy tính chỉ có ổ C, D, E... mà không có ổ A, B? - Ảnh 2." /></p>\n\n<p>&nbsp;Si&ecirc;u m&aacute;y t&iacute;nh&nbsp;Fujitsu K của Nhật.</p>\n\n<p>Bỏ ra khoản đầu tư khủng khiếp l&agrave; 1,4 tỷ USD, Nhật Bản sử dụng chiếc si&ecirc;u m&aacute;y t&iacute;nh n&agrave;y nhằm mục đ&iacute;ch ph&ograve;ng chống thi&ecirc;n tai v&agrave; biến đổi kh&iacute; hậu.</p>\n\n<p>Được biết, si&ecirc;u m&aacute;y t&iacute;nh n&agrave;y ngốn 10 triệu USD tiền điện mỗi năm với lượng điện năng cần thiết để vận h&agrave;nh l&agrave;&nbsp;9.89 MW!&nbsp;Con số n&agrave;y tương đương với lượng điện năng của 10.000 hộ gia đ&igrave;nh sử dụng trong 1 năm.</p>\n', 1, 'posts_ucxKayQq.JPG', 9, '2016-05-17', 'Administrator', '2016-05-17', '', 0, '', ''),
(5, 'Trong tương lai, cả thế giới có thể nói chung một ngôn ngữ, với thiết bị này', 'trong-tuong-lai-ca-the-gioi-co-the-noi-chung-mot-ngon-ngu-voi-thiet-bi-nay', '<p>Waverly Labs c&oacute; lẽ sắp tung ra một trong những sản phẩm mang t&iacute;nh c&aacute;ch mạng đột ph&aacute; nhất hiện nay, gi&uacute;p con người tr&ecirc;n khắp thế giới n&agrave;y &quot;n&oacute;i chung 1 ng&ocirc;n ngữ&quot;.</p>\r\n\r\n<p>Thiết bị n&agrave;y được nh&agrave; sản xuất gọi l&agrave; The Pilot - một cặp tai nghe kh&ocirc;ng d&acirc;y c&oacute; khả năng dịch ng&ocirc;n ngữ theo thời gian thực, dưới sự trợ gi&uacute;p của phần mềm chuyển ngữ (hoạt động tr&ecirc;n smartphone) cũng do Waverly Labs tự thiết kế.</p>\r\n\r\n<p>The Pilot được cung cấp theo cặp, để cuộc hội thoại giữa 2 người với 2 ng&ocirc;n ngữ ho&agrave;n to&agrave;n kh&aacute;c biệt c&oacute; thể diễn ra kh&ocirc;ng kh&aacute;c g&igrave; những cuộc hội thoại c&ugrave;ng ng&ocirc;n ngữ.</p>\r\n\r\n<p><img alt="\r\nThe Pilot phiên bản thử nghiệm.\r\n" id="img_dd22a790-1be7-11e6-b3d1-11e3aadf807b" src="https://cafebiz.vcmedia.vn/k:thumb_w/660/2016/2016-05-17-1-1463459229813/trong-tuong-lai-ca-the-gioi-co-the-noi-chung-mot-ngon-ngu-voi-thiet-bi-nay.jpg" /></p>\r\n\r\n<p>The Pilot phi&ecirc;n bản thử nghiệm.</p>\r\n\r\n<p>Cặp tai nghe n&agrave;y cũng c&oacute; khả năng nghe nhạc như c&aacute;c tai nghe kh&ocirc;ng d&acirc;y th&ocirc;ng thường, đồng thời, người d&ugrave;ng c&oacute; thể lựa chọn cặp ng&ocirc;n ngữ sử dụng th&ocirc;ng qua điện thoại.</p>\r\n\r\n<p>Ngo&agrave;i việc truy vấn v&agrave;o cơ sở dữ liệu online, The Pilot cũng c&oacute; thể dịch offline để cung cấp khả năng dịch gần như tức thời cho người sử dụng.</p>\r\n\r\n<p>Đội ngũ của Waverly Labs đ&atilde; d&agrave;nh 2 năm nghi&ecirc;n cứu, trước khi tung ra những h&igrave;nh ảnh đầu ti&ecirc;n về thiết bị mang t&iacute;nh c&aacute;ch mạng n&agrave;y. Dự kiến, sản phẩm sẽ được b&aacute;n ra trong năm nay với mức gi&aacute; chưa được tiết lộ.</p>\r\n\r\n<p>V&agrave; cũng tương tự như cộng đồng Kickstarter, người mua đặt trước sẽ được hưởng mức gi&aacute; ưu đ&atilde;i hơn. Nh&agrave; sản xuất dự kiến sẽ b&aacute;n chiếc The Pilot với gi&aacute; 249 - 299 USD, nhưng d&agrave;nh mức gi&aacute; ưu đ&atilde;i 129, 149 v&agrave; 179 USD cho những người đặt h&agrave;ng sớm.</p>\r\n', 1, 'posts_2tjDrVNU.JPG', 9, '2016-05-17', 'Administrator', '0000-00-00', '', 0, '', ''),
(6, 'iPad Pro 9.7 inch dính lỗi ngay sau khi cập nhật lên iOS 9.3.2', 'ipad-pro-9-7-inch-dinh-loi-ngay-sau-khi-cap-nhat-len-ios-9-3-2', '<p>H&ocirc;m qua, Apple đ&atilde; bắt đầu tung ra bản cập nhật iOS 9.3.2 với tuy&ecirc;n bố sẽ khắc phục một số lỗi nhỏ của phi&ecirc;n bản trước. Tuy nhi&ecirc;n, chỉ &iacute;t giờ sau khi bản cập nhật được ph&aacute;t h&agrave;nh, một số người d&ugrave;ng iPad Pro 9.7 inch đ&atilde; b&aacute;o c&aacute;o về một lỗi mới ph&aacute;t sinh tr&ecirc;n thiết bị của họ.</p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p><img alt="" id="img_87e27bc0-1c05-11e6-b3d1-11e3aadf807b" src="https://genknews.vcmedia.vn/k:2016/pro-1463471976522/ipad-pro-97-inch-dinh-loi-ngay-sau-khi-cap-nhat-len-ios-932.jpg" /></p>\r\n\r\n<p>Cụ thể, sau khi cập nhật l&ecirc;n iOS 9.3.2 v&agrave; kết nối với iTunes, chiếc iPad Pro 9.7 sẽ b&aacute;o lỗi &quot;Error 56&quot;.</p>\r\n\r\n<p>Tuy nhi&ecirc;n, t&agrave;i liệu hỗ trợ của Apple lại n&oacute;i rằng &quot;Error 56&quot; l&agrave; vấn đề ph&aacute;t sinh do phần cứng. Apple cũng khuy&ecirc;n người d&ugrave;ng n&acirc;ng cấp l&ecirc;n phi&ecirc;n bản iTunes mới nhất v&agrave; tiến h&agrave;nh kiểm tra lại một lần nữa để chắn chắn rằng vấn đề kh&ocirc;ng phải do ứng dụng bảo mật của b&ecirc;n thứ 3 g&acirc;y ra. Người d&ugrave;ng cũng n&ecirc;n kiểm tra lại c&aacute;p USB, m&aacute;y t&iacute;nh bảng v&agrave; kết nối mạng để đảm bảo tất cả vẫn đang hoạt động tốt.</p>\r\n\r\n<p>Tiếp sau đ&oacute;, Apple khuy&ecirc;n người d&ugrave;ng &quot;restore&quot; lại chiếc iPad của m&igrave;nh 2 lần, nếu th&ocirc;ng b&aacute;o lỗi vẫn xuất hiện h&atilde;y li&ecirc;n hệ với bộ phận chăm s&oacute;c kh&aacute;ch h&agrave;ng của Apple để được hướng dẫn c&aacute;ch xử l&iacute;.</p>\r\n', 1, 'posts_AcWHBp6O.jpg', 9, '2016-05-17', 'Administrator', '0000-00-00', '', 0, '', '');
...
(45, 'Trọn gói đi sinh cho mẹ bầu', 'tron-goi-di-sinh-cho-me-bau', 'HGUNHJ', 38, '', '590000', 1, 1, 240000, 59, '2016-05-31', 1, 0, 0, 0, NULL, 'product_HuYd6I9O.jpg', '', '2015-10-29', NULL, '2016-05-16', '', 2, '', '', 1, 153),
